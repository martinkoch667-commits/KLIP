...
export function SceneCurseurs() {
  return (
    <div className="fx-tete">
      ...
      <Fenetre>
        {/* « Tous vos clients » plutôt que « Six abonnements », qui laissait
            croire que Klip remplace chaque logiciel un pour un (Martin,
            2026-09-14). Un trait barrant les logos a été essayé puis retiré :
            il ne protégeait de rien et donnait moins envie. */}
