...
function promptJugement(
  ...
  return [
    ...
    '   ATTENTION, ce critère a fait rejeter des compositions justes : une écriture',
    '   MANUSCRITE, une CONDENSÉE d\'affiche ou un SERIF de presse sont des polices de',
    '   GESTE. Une charte de client n\'en fournit presque jamais, et la composition a le',
    '   droit d\'en poser une là où son dessin le demande. Ce n\'est PAS une infraction.',
    '   L\'infraction, c\'est une police quelconque à la place de la police de titre de la',
    '   marque sur le TITRE.',
    ...
    '   b) EST-CE QUE ÇA SE DÉTACHE DE CE QU\'IL Y A JUSTE DERRIÈRE ? Le contraste se juge',
    '      sur le fond RÉEL sous ce texte, pas sur l\'impression générale du visuel. Un',
    '      texte sombre sur une zone sombre, un texte clair sur une zone claire, un texte',
    '      de couleur sur un aplat de la même famille de couleur : c\'est du ton sur ton,',
    '      et c\'est un défaut MÊME SI la couleur est parfaitement dans la charte. Une',
    '      couleur juste mal posée reste mal posée.',
