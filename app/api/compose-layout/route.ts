...
export async function POST(request: NextRequest) {
  try {
    ...
    const prompt = [
      ...
      'RÈGLE DE GOÛT STRICTE : ne mets JAMAIS un gros rectangle/bloc de couleur plein derrière le texte (c\'est moche et amateur). Pour la lisibilité, utilise UNIQUEMENT le scrim dégradé ou l\'ombre. Les "accents" sont des traits FINS (soulignement court, fine barre), jamais des pavés.',
      'Sois créatif et éditorial (pense magazine), pas générique. Reste lisible et pro.',
      '',
