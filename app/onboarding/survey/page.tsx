...
const SV_CSS = `
  ...
  .sv-bar.done{background:var(--leaf);}
  ...
  .sv-choice:hover{border-color:var(--leaf);background:var(--mint-soft);}
  ...
  .sv-btn:hover:not(:disabled){background:var(--leaf);color:var(--forest);}
