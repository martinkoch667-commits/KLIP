...
function MiniCalendar() {
  return (
    <div style={{ borderRadius: 14, overflow: 'hidden', boxShadow: 'inset 0 0 0 1px var(--line)', marginTop: 4, aspectRatio: '16/9' }}>
      <img src="media/calendar.png" alt="Calendrier éditorial KLIP" style={{ display: 'block', width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'top left' }} />
    </div>
  );
}
