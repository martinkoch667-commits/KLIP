...
function Sidebar({ route, setRoute, pendingTotal, selectClient }) {
  return (
    <aside className="sidebar">
      ...
      <button className="nav-item"><span className="nav-ic"><AIcon name="settings" size={19} /></span><span className="nav-label">Réglages</span></button>
...
function Topbar({ active, setActive, route, onCompose, toast }) {
  const titles = { dashboard: 'Tableau de bord', calendar: 'Calendrier éditorial', compose: 'Composer', editor: 'Composer un post', queue: 'File de publication', clients: 'Vos clients' };
  return (
